...
const _PencilSimpleIcon: IconComponent = ({ size, color, ...styledProps }) => {
...
const PencilSimpleIcon = assignWithoutSideEffects(_PencilSimpleIcon, {
  componentId: 'PencilSimpleIcon',
});
