...
const _FileFillIcon: IconComponent = ({ size, color, ...styledProps }) => {
...
const FileFillIcon = assignWithoutSideEffects(_FileFillIcon, {
  componentId: 'FileFillIcon',
});
