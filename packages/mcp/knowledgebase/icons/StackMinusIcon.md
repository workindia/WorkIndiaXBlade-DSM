...
```typescript
import { StackMinusIcon } from '@workindia/dsm';
```
...
const Example = () => {
  return <StackMinusIcon size="medium" color="surface.icon.primary.normal" />;
};
```

## Related Icons

StackMinusFillIcon, StackMinusOutlineIcon, StackMinusIcon, PlusIcon
