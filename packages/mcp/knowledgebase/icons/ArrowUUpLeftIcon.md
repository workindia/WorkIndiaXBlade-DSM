...
```typescript
import { ArrowUUpLeftIcon } from '@workindia/dsm';
```
...
const Example = () => {
  return <ArrowUUpLeftIcon size="medium" color="surface.icon.primary.normal" />;
};
```

## Related Icons

ArrowUUpLeftFillIcon, ArrowUUpLeftOutlineIcon, ArrowUUpLeftIcon
