...
```typescript
import { ArrowUUpRightIcon } from '@workindia/dsm';
```
...
const Example = () => {
  return (
    <ArrowUUpRightIcon size="medium" color="surface.icon.primary.normal" />
  );
};
```
...
ArrowUUpRightFillIcon, ArrowUUpRightOutlineIcon, ArrowUUpRightIcon
