...
```typescript
import { HandHeartIcon } from '@workindia/dsm';
```
...
const Example = () => {
  return <HandHeartIcon size="medium" color="surface.icon.primary.normal" />;
};
```

## Related Icons

HandHeartFillIcon, HandHeartOutlineIcon, HandHeartIcon
