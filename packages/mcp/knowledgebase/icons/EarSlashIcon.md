...
```typescript
import { EarSlashIcon } from '@workindia/dsm';
```
...
const Example = () => {
  return <EarSlashIcon size="medium" color="surface.icon.primary.normal" />;
};
```

## Related Icons

EarSlashFillIcon, EarSlashOutlineIcon, EarSlashIcon
