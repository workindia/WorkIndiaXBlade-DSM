...
```typescript
import { ChartLineIcon } from '@workindia/dsm';
```
...
const Example = () => {
  return <ChartLineIcon size="medium" color="surface.icon.primary.normal" />;
};
```

## Related Icons

ChartLineFillIcon, ChartLineOutlineIcon, ChartLineIcon
