...
```typescript
import { ChartPieIcon } from '@workindia/dsm';
```
...
const Example = () => {
  return <ChartPieIcon size="medium" color="surface.icon.primary.normal" />;
};
```

## Related Icons

ChartPieFillIcon, ChartPieOutlineIcon, ChartPieIcon
