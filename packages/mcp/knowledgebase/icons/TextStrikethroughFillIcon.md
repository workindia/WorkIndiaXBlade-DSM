...
Represents text strikethrough formatting. The filled strikethrough icon provides a more prominent appearance for applying strikethrough (crossed-out) styling in rich text editors or document editors.
...
- Showing price reductions as prominent feature
...
```typescript
import { TextStrikethroughFillIcon } from '@workindia/dsm';
```
