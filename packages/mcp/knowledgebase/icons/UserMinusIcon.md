...
```typescript
import { UserMinusIcon } from '@workindia/dsm';
```
...
const Example = () => {
  return <UserMinusIcon size="medium" color="surface.icon.primary.normal" />;
};
```

## Related Icons

UserMinusFillIcon, UserMinusOutlineIcon, UserMinusIcon, PlusIcon, UsersIcon
