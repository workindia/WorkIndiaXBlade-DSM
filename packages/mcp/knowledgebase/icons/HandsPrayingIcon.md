...
```typescript
import { HandsPrayingIcon } from '@workindia/dsm';
```
...
const Example = () => {
  return <HandsPrayingIcon size="medium" color="surface.icon.primary.normal" />;
};
```

## Related Icons

HandsPrayingFillIcon, HandsPrayingOutlineIcon, HandsPrayingIcon
