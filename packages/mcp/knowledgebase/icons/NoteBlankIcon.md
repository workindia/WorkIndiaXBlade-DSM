...
```typescript
import { NoteBlankIcon } from '@workindia/dsm';
```
...
const Example = () => {
  return <NoteBlankIcon size="medium" color="surface.icon.primary.normal" />;
};
```

## Related Icons

NoteBlankFillIcon, NoteBlankOutlineIcon, NoteBlankIcon
