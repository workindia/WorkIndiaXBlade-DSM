...
```typescript
import { PlusMinusIcon } from '@workindia/dsm';
```
...
const Example = () => {
  return <PlusMinusIcon size="medium" color="surface.icon.primary.normal" />;
};
```

## Related Icons

PlusMinusFillIcon, PlusMinusOutlineIcon, PlusMinusIcon, MinusIcon, PlusIcon
