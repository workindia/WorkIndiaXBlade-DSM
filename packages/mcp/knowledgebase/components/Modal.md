...
import { useBreakpoint, useTheme } from '@workindia/dsm';
      ...
      >
        <Box display="flex" flexDirection="column" gap="spacing.6">
          ...
          <Text size="medium" color="surface.text.gray.muted">
            We've made several improvements to enhance your experience. Here are
            the key updates:
          </Text>
          <List>
          ...
          >
            <Text size="small" color="surface.text.gray.muted">
              These updates are now live. For more details, please visit our
              documentation.
            </Text>
          </Box>
        </Box>
