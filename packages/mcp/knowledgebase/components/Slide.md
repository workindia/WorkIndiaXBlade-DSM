...
import { Slide, Box, Button, Card, CardBody, Text } from '@workindia/dsm';
    ...
    <Box padding="spacing.6">
      ...
      <Slide isVisible={isVisible} direction="bottom">
        <Card width="100%" height="100%">
          <CardBody>
            <Text>
              This card slides in from the bottom and out to the bottom when the
    ...
    >
      ...
      <Slide motionTriggers={['in-view']} direction="left">
        <Card marginBottom="spacing.6">
          ...
          <CardBody>
            <Text>
              This card slides in from the left when scrolled into view
            </Text>
          </CardBody>
        </Card>
      </Slide>
      ...
      <Slide motionTriggers={['in-view']} direction="right" delay="gentle">
        <Card marginBottom="spacing.6">
          ...
          <CardBody>
            <Text>
              This card slides in from the right with a gentle delay when
              scrolled into view
            </Text>
          </CardBody>
        </Card>
      ...
      <Slide motionTriggers={['in-view']} direction="bottom">
        <Card>
          ...
          <CardBody>
            <Text>
              This card slides in from the bottom when scrolled into view
            </Text>
          </CardBody>
        </Card>
      </Slide>
