...
import { Fade, Box, Card, CardBody, Heading, Text } from '@workindia/dsm';
        ...
        <Card>
          <CardBody>
            ...
            <Text>
              ...
              The 'in-view' motion trigger activates the animation when the
            ...
            <Card>
              ...
              <CardBody>
                <Text>
                  ...
                  Each route uses a Fade component to create a smooth transition
                  effect.
                </Text>
              </CardBody>
            </Card>
            ...
            <Card>
              ...
              <CardBody>
                <Text>
                  ...
                  Using a unique key with the Fade component ensures the
                  animation plays for each route change.
                </Text>
              </CardBody>
            </Card>
          </Fade>
        ...
        <Route path="/">
          <Fade key="home" motionTriggers={['mount']} type="in">
            <Card>
              ...
              <CardBody>
                <Text>
                  This is the home page with a fade-in animation. The mount
                  trigger ensures the content fades in when the route loads.
                </Text>
              </CardBody>
            </Card>
          </Fade>
...
import { Fade, Box, Button, TextInput } from '@workindia/dsm';
