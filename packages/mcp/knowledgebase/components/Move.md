...
```tsx
import { Move } from '@workindia/dsm';
import { Card, CardBody, CardHeader, CardHeaderLeading } from '@workindia/dsm';
import { Text } from '@workindia/dsm';
      ...
      <Card>
        <CardHeader>
          <CardHeaderLeading
            ...
            subtitle="Get started with payments"
          />
        </CardHeader>
        <CardBody>
          <Text>
            This card animates in with a smooth motion when the component
            mounts.
          </Text>
        </CardBody>
      </Card>
