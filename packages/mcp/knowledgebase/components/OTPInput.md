...
import { OTPInput, Box, Button, Text } from '@workindia/dsm';
...
function ProgrammaticOTPExample() {
  ...
  return (
    <Box width="100%" maxWidth="568px">
      ...
      <Text size="small">
        Note: The OTPInput ref exposes an array of input references that can be
        used to programmatically focus specific inputs.
      </Text>
    </Box>
  );
}
