...
import { Box, Text, Heading, Button, RazorpayIcon } from '@workindia/dsm';
      ...
      >
        ...
        >
          ...
          <Text marginBottom="spacing.3">
            Perfect for individuals and small teams getting started with our
            platform.
          </Text>
...
```tsx
import React from 'react';
import { Box, Text, Button } from '@workindia/dsm';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text>
            This box has a slight rotation applied to create visual interest.
          </Text>
        </Box>
...
import { Box, Text, Heading } from '@workindia/dsm';
...
const ResponsiveGridExample = () => {
  ...
  const handleDrop = (e: React.DragEvent, destinationIndex: number) => {
    ...
    if (draggedItem !== null) {
      console.log(
        `Moved item from index ${draggedItem} to ${destinationIndex}`,
      );
    }
    setDraggedItem(null);
  };
  ...
  return (
    ...
    >
      ...
      <Text marginBottom="spacing.4">
        This grid adapts to screen size and supports hover effects and
        drag-and-drop.
      </Text>
