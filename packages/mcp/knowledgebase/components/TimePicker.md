...
> &
  Omit<
    ...
    'isOpen' | 'defaultIsOpen' | 'onOpenChange' | 'time'
  > & {
    /**
  ...
  return (
    <Box display="flex" flexDirection="column" gap="spacing.5">
      ...
      <TimePicker
        ...
        labelSuffix={
          <Tooltip
            content="Must be during business hours (9 AM - 6 PM)"
            placement="right"
          >
        ...
        errorText={
          hasError
            ? 'Please select time during business hours (9 AM - 6 PM)'
            : undefined
        }
        successText={
          !hasError && advancedTime ? 'Valid appointment time' : undefined
        }
