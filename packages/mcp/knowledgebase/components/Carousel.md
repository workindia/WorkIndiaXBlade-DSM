  ...
  const testimonials = [
    {
      ...
      quote:
        'We saw a 35% increase in conversion after integrating Razorpay Checkout.',
      author: 'Priya Sharma',
      company: 'TechStart',
    },
    {
      ...
      quote:
        'The API was easy to integrate and the dashboard provides great insights.',
      author: 'Rahul Gupta',
    ...
    },
    {
      ...
      quote:
        'Whenever we faced any issues, the support team was quick to respond.',
      author: 'Anita Desai',
      company: 'StyleBazaar',
    },
    {
...
const AutoPlayProductCarouselExample = () => {
  const products = [
    ...
    { id: 4, name: 'Custom Solution', description: 'Tailored to your needs' },
    {
      id: 5,
      name: 'Mobile Package',
      description: 'Optimize for mobile payments',
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        'Get your money in seconds with our instant settlement feature.',
