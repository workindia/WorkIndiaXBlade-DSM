    ...
    <Card>
      ...
      <CardBody>
        <Text>
          ...
          efficitur nisl nec dapibus volutpat. Sed vitae fringilla justo, in
          finibus metus. Nulla facilisi. Nunc ac luctus nisi, a ultrices purus.
        </Text>
      </CardBody>
      <CardFooter>
        <CardFooterLeading
...
import { useBreakpoint } from '@workindia/dsm';
    ...
    >
      <CardHeader showDivider={false}>
        <CardHeaderLeading
          ...
          subtitle={
            isMobile
              ? 'TPV for the current month'
              : 'Total Payment Volume for the current month'
          }
        />
        <CardHeaderTrailing
          visual={
