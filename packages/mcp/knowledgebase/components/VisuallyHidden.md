...
```tsx
import { VisuallyHidden, Checkbox, Box, Text } from '@workindia/dsm';
  ...
  return (
    <Box padding="spacing.4">
      ...
      <Box marginTop="spacing.5">
        <Text marginBottom="spacing.3">
          This technique is useful when you want to provide additional context
          to screen reader users without cluttering the visual interface.
        </Text>
      </Box>
    </Box>
  );
