...
```tsx
import { ToastContainer, useToast, Box, Button } from '@workindia/dsm';
    ...
    toast.show({
      ...
      content: (
        <Box display="flex" gap="spacing.3" flexDirection="column">
          ...
          <Text size="xsmall">
            Turbo UPI allows end-users to complete their payment in-app, with no
            redirections or dependence on third-party UPI apps. With Turbo UPI,
            payments will be 5x faster with a significantly-improved success
            rate of 10%!
          </Text>
        </Box>
      ),
    ...
    toast.show({
      ...
      content: (
        <Box display="flex" gap="spacing.3" flexDirection="column">
          ...
          <Text size="xsmall">
            Get your funds instantly with our new settlement option. Available
