...
import { Box, Breadcrumb, BreadcrumbItem, HomeIcon } from '@workindia/dsm';
...
const ResponsiveBreadcrumb = () => {
  ...
  const navigationItems = [
    ...
    {
      label: 'Accessories',
      href: '/products/electronics/computers/laptops/gaming/accessories',
    },
    {
      ...
      <Breadcrumb size="medium" color="primary">
        {navigationItems.map((item, index) => (
          <BreadcrumbItem
            ...
            accessibilityLabel={
              item.icon && !item.label ? item.label : undefined
            }
          >
            {item.label}
          </BreadcrumbItem>
