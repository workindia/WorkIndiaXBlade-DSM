...
```tsx
import { TextInput, Box } from '@workindia/dsm';
...
```tsx
import { TextInput, Box, SearchIcon, UserIcon } from '@workindia/dsm';
...
import { TextInput, Box, MailIcon } from '@workindia/dsm';
  ...
  return (
    <Box display="flex" flexDirection="column" gap="spacing.5">
      ...
      <TextInput
        ...
        successText={
          rawPhoneNumber.length === 10 ? 'Valid phone number' : undefined
        }
