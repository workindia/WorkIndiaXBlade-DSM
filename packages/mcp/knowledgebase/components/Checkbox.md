...
const PaymentSetupForm = () => {
  ...
  const someMethodsSelected =
    selectedPaymentMethods.length > 0 && !allMethodsSelected;
    ...
    <form onSubmit={handleSubmit}>
      ...
      <Box display="flex" flexDirection="column" gap="spacing.4">
        ...
        <Checkbox
          ...
          validationState={
            formSubmitted && noMethodsSelected ? 'error' : 'none'
          }
          size="medium"
        >
        ...
        >
          <Checkbox
            value="credit_card"
            helpText="Visa, Mastercard, American Express, etc."
          >
            Credit Cards
          </Checkbox>
          <Checkbox
            value="debit_card"
            helpText="Visa Debit, Maestro, RuPay, etc."
          >
            Debit Cards
          </Checkbox>
      ...
      <Box display="flex" flexDirection="column" gap="spacing.4">
        ...
        >
          ...
          <Checkbox value="subscription_management">
  ...
  return (
    <form>
      ...
      <CheckboxGroup
        ...
        validationState={
          showValidation && selectedFeatures.length === 0 ? 'error' : 'none'
        }
